...
### Fixed
- Import job polling now scopes direct job lookups to the authenticated user, preventing users from reading another user's import results by guessing a job ID.
