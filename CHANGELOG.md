...
### Changed
- Custom category shared fields now persist through `details_json` for create/import/edit/report flows, while fixed shared fields continue to use asset columns.
