...
/**
 * Parse a composite antivirus cell, e.g. "Kaspersky - 45 days".
 */
function parseAntivirusComposite(raw) {
  if (isMissing(raw)) {
...
function applyAntivirusCompositeToDetails(details) {
...
module.exports = {
  parseAntivirusComposite,
  applyAntivirusCompositeToDetails,
};
